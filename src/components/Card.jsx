    ...
    return (
        <>
            <div className="text-center mt-8 mb-12 md:mt-12 md:mb-16" {...getToggleProps({
                ...
                <div id={props.id} className={`bg-[#C5D4DE] w-11/12 md:max-w-2xl mx-auto p-3 md:p-6 rounded-xl border border-[#b3b3b3] shadow-md ${expanded ? "pb-4 md:pb-4" : "pb-4 md:pb-0"}`} onMouseEnter={handleCardEnter} onMouseLeave={handleCardExit} onFocus={handleCardEnter}>
                    <div className="">
                ...
                {/* <div className="relative bottom-7 scale-75">
                    <button className={`rounded-full shadow-md outline-[#9f9f9f] ${expanded ? "rotate-45 transition-all" : "transition-all"}`}                   >
